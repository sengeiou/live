...
public class ClipboardUtil {
     ...
     * @return
     */
    public static void getText(final Context context, View v, final ClipListener clipListener) {
...
//            Log.d(TAG, "tryGetTextNow: "+ JSON.toJSONString(cdText.getItemAt(0)));
    ...
    public static boolean copyToClipboard(final Context context, String str, final boolean showToast) {
        if ("".equals(str)) {
        }
        if (android.os.Build.VERSION.SDK_INT >= 29) {
            EditText et = new EditText(context);
    ...
    public static boolean copyToClipboardForce(final Context context, String str, final boolean showToast) {
        if ("".equals(str)) {
        }
        if (android.os.Build.VERSION.SDK_INT >= 29) {
            EditText et = new EditText(context);
